pfUI:RegisterModule("firstrun", "vanilla:tbc", function ()
  ...
  pfUI.firstrun:AddStep("profile", function()
    ...
    f.Sandworlds = CreateFrame("Button", nil, f, "UIPanelButtonTemplate")
    f.Sandworlds:SetWidth(120)
    f.Sandworlds:SetHeight(20)
    f.Sandworlds:SetPoint("BOTTOM", -65, 100)
    f.Sandworlds:SetTextColor(1,1,1)
    f.Sandworlds:SetText("Sandworlds")
    f.Sandworlds:SetScript("OnClick", function()
      _G["pfUI_config"] = CopyTable(pfUI_profiles["Sandworlds"])
      pfUI:LoadConfig()
      ReloadUI()
    end)
    SkinButton(f.Sandworlds)
